...
import {
  activityFromPersistedRow as activityFromSupabaseRow,
  activityToPersistedRow as activityToSupabaseRow,
  destinationFromPersistedRow as destinationFromSupabaseRow,
  destinationToPersistedRow as destinationToSupabaseRow,
  mediaAssetFromPersistedRow as mediaAssetFromSupabaseRow,
  routeLegFromPersistedRow as routeLegFromSupabaseRow,
  routeLegToPersistedRow as routeLegToSupabaseRow,
  type PersistedActivityRow as SupabaseActivityRow,
  type PersistedDestinationRow as SupabaseDestinationRow,
  type PersistedMediaAssetRow as SupabaseMediaAssetRow,
  type PersistedMediaSignedUrls as SupabaseMediaSignedUrls,
  type PersistedRouteLegRow as SupabaseRouteLegRow,
} from './persistedRows';
